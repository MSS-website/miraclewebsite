...
<body>
      ...
      <br>
        ...
        <div class="row">
          <div class="col-sm-7 text-left">
            <div class="pageTitle">
              <strong>US Opportunities</strong>
            </div>
          </div>
   ...
   include '../config/Locations.php';
        ...
        try {
             ...
             $conn->selectDatabase();
             $selectQuery = "SELECT JobId,JobTitle,JobTagline,JobDescription,JobPosition,JobQualification,JobTechnical,JobSoftSkills,JobShifts,JobCountry,Location,JobLogo FROM tblJobDescriptions WHERE JobCountry = 'USA' AND JobStatus = 'Active'";
             ...
             while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
                 ...
                 ?>
                           ...
                           <div class="col-sm-4"><!-- Job Item -->
                                <center>
                                     <img src="../images/jobs/jobs6.png" class="img-responsive" alt="Responsive image"/> 
