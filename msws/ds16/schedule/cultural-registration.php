                                ...
                                <form role="form" method="post" action="" accept-charset="UTF-8">
                                     <div class="col-sm-4">
                                        ...
                                        <select id="competitionType" class="form-control" name="competitionType" required="true" >
                                            <option value="" selected="selected" disabled="disabled">Select Competition Type</option>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" id="collegeName" class="form-control" name="collegeName" placeholder="Name of College / Company" required="true" onchange="fieldLengthValidator(this);">
                                    </div>
                                    <div class="col-sm-4">
                                       
                                        <input type="text" id="leaderName" class="form-control" name="leaderName" placeholder="Leader Name" required="true" onchange="fieldLengthValidator(this);">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="text" id="leaderEmail" class="form-control" name="leaderEmail" placeholder="Leader Email" required="true" onchange="return checkEmail(this);fieldLengthValidator(this);">
                                    </div>
                                    <div class="col-sm-4">
                                        
                                        <input type="text" id="leaderPhoneNumber" class="form-control" name="leaderPhoneNumber" placeholder="Leader Phone No:" required="true" onchange="return formatPhone(this);">
                                    </div>
                                    <div class="col-sm-4">
                                       
                                        <input type="text" id="teamSize" class="form-control" name="teamSize" placeholder="Team Size" required="true" onkeypress="return isNumberKey(event)">
                                    </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                   <div class="col-sm-12">
                                        ...
                                        <input type="text" id="auditionLink" class="form-control" name="auditionLink" placeholder="Audition link" required="false" onchange="isUrl(this);return fieldLengthValidator(this);">
                                    </div>
                                  

                                    <div class="col-sm-12" style="margin-top:15px">
                                       
                                        <textarea placeholder="Team Member Names" rows="3" class="form-control" id="teamMemberNames" name="teamMemberNames" onchange="fieldLengthValidator(this);"></textarea>
                                    </div>
                                    <div class="col-sm-12" style="margin-top:15px">
                                        
                                        <textarea placeholder="Comments(Optional)" rows="3" class="form-control" id="comments" name="comments" onchange="fieldLengthValidator(this);"></textarea>
                                    </div>
                                     ...
                                     <br>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                    ...
                                                    <button type="submit" class="btn col-sm-4 btn-info" id="btnSubmit" name="btnSubmit" value="Submit">Register</button> 
                                            </div>
