...
<html lang="en">
    <head>
        ...
        if (isset($_POST['btnGenerateExcel'])) {
            header('Location: ExportContactUsData.php');
        }
        ?>
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        ...
                        <div class="location_map col-sm-6">
                            <h2 style="color: peachpuff;" class=""> Digital Summit 2016<br><small style="color:#fff">ContactUs Data</small></h2>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row" style="margin-top:40px; margin-bottom:45px;">
                        ...
                        <div class="col-sm-6 text-left">
                            ...
                            <h1 style="color:#fff"><strong>ContactUs Data</strong></h1>
                        </div>
                        <div class="col-sm-6 text-right">
                            <ul class="breadcrumb pull-right">
                                <li><a href="AdminHome.php"><font color="#fff">Admin Home</font></a></li>

                                <li class="active"><font color="#fff"><strong>ContactUs Data</strong></font></li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading tabl_head">
                                <div class="col-sm-11">    ContactUs Data</div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table class="table table-hover table-striped" id="cont_tab">
                                            <thead>
                                                <tr>
                                                    <th>SNO</th>
                                                    <th>Name</th>
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                try {
                                                    $selectQuery = "SELECT Id,PersonName,Email,MobileNumber,Description,CreatedDate FROM tblConfContactUs";
