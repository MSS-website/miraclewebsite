...
<head>
    ...
    <title>Pongal Celebration 2015 | Miracle</title>
    ...
    <br>
        ...
        <div class="row">
          <div class="col-sm-7 text-left">
            <h1 class="heavy">Pongal Celebrations 2015</h1>
          </div>
          <div class="col-sm-5 text-right">
            <ul class="breadcrumb pull-right">
                <li><a href="../">Home</a></li>
                <li><a href="../events/recent.php">Events</a></li>
                <li class="active">Pongal Celebrations 2015</li>
            </ul>
          </div>
        </div>
