...
<html lang="en">
    <head>
        ...
        <title>
            Holi - Festival of Colors | Miracle
        </title>
        ...
        <section class="container" id="career">
            ...
            <div class="row">
                ...
                <div class="col-sm-5 text-right">
                    <ul class="breadcrumb pull-right">
                        ...
                        <li class="active">Holi Celebrations
                        </li>
                    </ul>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="jumbotron">
                        <p class="methodText">
                            <strong>March 6th - Miracle City & Miracle Heights, IND :</strong> Holi Festival of Colours is a 16 day unique adventure in India. It is one of the major festivals in India and the most vibrant of all. According to mythology, we celebrate this festival as a bonfire death of Holika, the sister of Hiranyakashipu. We celebrate this festival as a significance of Undying love of Radha for Lord Krishna.
                        </p>
                        <p class="methodText">
