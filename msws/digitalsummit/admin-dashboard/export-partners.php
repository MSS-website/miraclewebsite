...
try {
	$queryString = "SELECT PartnerName,OrganizationName,Designation,Email,PhoneNumber,ReasonTobePartner,
DATE(Createddate) AS Createddate FROM tblDs17Partners ORDER BY id";
...
<head></head><body><table border='1' style='width:100%'>
    <tr style='width:800px;height:100px; valign='center''>
		        ...
		        <th valign='center'>   PartnerName    </th>
			    ...
			    <th valign='center'>   ReasonTobePartner    </th>
	...
	while ($row = $stmt->fetch()) {
		...
		<tr valign="center">
			            ...
			            <td valign="center">' . $PartnerName. '</td>
                        ...
                        <td valign="center">' . $ReasonTobePartner. '</td>
