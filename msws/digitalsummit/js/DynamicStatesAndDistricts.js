...
{ 
	...
	if(data=='Andhra Pradesh'){
		var options = ["Anantapur", "Chittoor", "East Godavari", "Guntur","Kadapa","Krishna","Kurnool","Prakasam","Sri Potti Sriramulu","Srikakulam","Visakhapatnam","Vizianagaram"];
