...
<html lang="en">
   <head>
      ...
      <meta name="description" content="Miracle digital library offers you many tutorials for quality and assurance enigineering and we can learn more about how technology is driving new change in enterprises">
      <meta name="author" content="">
      <title>More Resources - QA | Miracle</title>
  ...
  include '../../config/general.php';
    ...
    $validationType='';
     $objId=2;
               $refId=119; //http://www.miraclesoft.com/events/webinar-after.php?eventId=147
            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">More Resources</h1>
                  </div>
                  <div class="col-sm-6 text-right">
                     <ul class="breadcrumb pull-right">
                        <li><a href="../../">Home</a></li>
                        <li><a href="../">Services</a></li>
                        <li class="active">More Resources</li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                   <br>
                   <p class="methodText">Miracle has been a Thought Leader in the space of software delivery and development and has assisted numerous organizations in improving their processes and efficiency. Through our <a class="linkText1" href="http://www.miraclesoft.com/library/"> <strong>Digital Library</strong></a> you can learn more about how technology is driving new change in enterprises.  </p>
               </div>
           <br>
                  ...
                  <div class="row hoverform" >
                        ...
                        <div class="col-sm-12" style="background-color:rgba(255,255,255,1);">
                           <ul class="nav nav-tabs">
                            ...
                            <li class="active">
                                <a data-toggle="tab" href="#sign-in-for-access" id="signupToggle"><h6 class="bluefont"><strong>Sign Up </strong></h6></a>
                            </li>
                            <li class="">
                                   ...
                                   <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="submit" class="btn btn-primary col-sm-12" data-loading-text="<i class='fa fa-spinner fa-spin '></i> loading..." style="margin-left:1px;" name="btnLoginSubmit" id="btnLoginSubmit" onclick="doSubmit();" tabindex="3" value="Login"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 noMargin">
                                            <p class="methodText">Forgot password!<a href="../../forgot-password" class="linkText"><strong> Click here.</strong></a></p> 
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4"><!--webinar--->
                                       ...
                                       <div class="embed-responsive embed-responsive-16by9">
                                           <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=147"><img src="<?= AMAZON_URL ?>/images/quality-assurance/testmanager.png" alt="testmanager" class="img-responsive"></a>
                    
                                       </div>
                                        <a class="linkText1" target="_blank"  href="https://www.miraclesoft.com/events/webinar-after.php?eventId=147">
                                          <div class="container" style="background-color:#eee;padding-bottom: 18px;">
                        
                                                <p style="margin-top:19px;"><center><strong> Exploring QA with Microsoft Test Manager and Team Foundation Server</strong></center></p>
                                          </div>
                                       </a>
                                     ...
                                     <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/end-to-end-manual-testing-global-financial-holdings-enterprise.php"><img  src="<?= AMAZON_URL ?>/images/quality-assurance/atlanticus-financial.png" alt="Global Financial Holdings" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">
                                
                                             <p><center><strong>End-to-End Manual Testing for Global Financial Holdings Enterprise </strong></center><br></p> 
                                            </div>
                                              </a>
                                            </div>
                                           </div>
                                      ...
                                      <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                                  ...
                                                  <div class="effect ">
                                              <div class="card">
                                               <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/testing-coe-global-carpet-manufacturer.php"><img  src="<?= AMAZON_URL ?>/images/quality-assurance/interface.png" alt="Testing COE" class="img-responsive">
                                                  <div class="container" style="background-color:#eee;">
                                
                                                        <p><center><strong>Establishing Testing COE for Global Carpet <br>Manufacturer</strong></center><br></p> 
                                                  </div>
                                               </a>
                                           </div>
                                           </div>
                                ...
                                <div class="row">
                                     <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/erp-testing-services-major-construction-materials-customer.php"><img src="<?= AMAZON_URL ?>/images/quality-assurance/bmc.png" alt="ERP Testing Services" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">
                                
                                             <p><center><strong>ERP Testing Services for Major Construction Materials </br>Customer</strong></center></p> 
                                            </div>
                                              </a>
                                            </div>
                                           </div>
                                    ...
                                    <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                               ...
                                               <div class="effect ">
                                              <div class="card">
                                                <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/automation-testing-web-services-large-retailer.php"><img  src="<?= AMAZON_URL ?>/images/quality-assurance/bhelk.png" alt="Automation Testing" class="img-responsive">
                                                  <div class="container" style="background-color:#eee; padding-bottom:18px;">
                                      ...
                                      <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/manual-automation-testing-leading-beverages-customer.php"><img src="<?= AMAZON_URL ?>/images/quality-assurance/coke.png" alt="Leading Beverages" class="img-responsive">
                                               <div class="container" style="background-color:#eee; ">
                                
                                             <p><center><strong>Manual and Automation Testing for a Leading Beverages<br> Customer</strong></center></p> 
                                            </div>
                                              </a>
                                            </div>
                                           </div>
                                ...
                                <div class="row">
                                      ...
                                      <div class="col-sm-4"><!--case study--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/library/CaseStudy/end-to-end-validation-qa-testing.php"><img  src="<?= AMAZON_URL ?>/images/quality-assurance/interface.png" alt="Global Financial Holdings" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">
                                
                                             <p><center><strong>End-to-End Validation QA and Testing for Finanical Holdings Firms</strong></center></p> 
                                            </div>
                                              </a>
                                            </div>
                                           </div>
                                     ...
                                     <div class="col-sm-4"><!--webinar--->
                                        <div class="portfolio-item">
                                              ...
                                              <div class="effect ">
                                              <div class="card">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/webinars/testing-as-a-service-simple-on-demand-pay-as-you-go-model"><img  src="<?= AMAZON_URL ?>/images/quality-assurance/testingwebinar.png" alt="testingwebinar" class="img-responsive">
                                               <div class="container" style="background-color:#eee;">
                                
                                             <p><center><strong>Testing-as-a-Service - Simple, On-Demand and Pay-as-you-go <br>Model</strong></center></p> 
                                            </div>
                                              </a>
                                            </div>
                                           </div>
        ...
        <div class="col-sm-3  sidebar pull-right">
            ...
            <div class="list-group">
               <a href="index.php" class="list-group-item-1">
                  <div>
                     <center><strong><font size="3%!important" color="#ffffff" onmouseout="this.style.color='#fff'" onmouseover="this.style.color='#b7b2b3'" style="color: rgb(255, 255, 255);">&nbsp;Quality Assurance and Engineering 
              ...
              <a href="managed-testing-services" class="list-group-item">
               ...
               <a href="#" class="list-group-item">
                  <div>
                     <center><strong><font size="3%!important" color="#00aae7">&nbsp; More Resources
                        </font></strong>
                     </center>
                  </div>
               </a>
    ...
    background-color: #000;
         ...
         background-size: cover;
          height:120px;
                        ...
                        <center>
                           <a href="http://www.miraclesoft.com/library/CaseStudy/testing-coe-global-carpet-manufacturer.php">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#ffffff"><strong>Establishing Testing COE for Global Carpet Manufacturer</strong></font></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/library/CaseStudy/testing-coe-global-carpet-manufacturer.php" target="_blank">
               ...
               <div>
                  <ul class="footer-nav footer-nav-links list-inline">
                     <li><a href="https://www.facebook.com/miracle45625" target="_blank" class="social-facebook" data-toggle="tooltip" title="" data-original-title=""><i class="fa fa-fw fa-facebook"></i></a></li>
                     <li><a href="https://twitter.com/Team_MSS" target="_blank" class="social-twitter" data-toggle="tooltip" title="" data-original-title=""><i class="fa fa-fw fa-twitter"></i></a></li>
                     <li><a href="https://plus.google.com/105262074634409319991/" target="_blank" class="social-google-plus" data-toggle="tooltip" title="" data-original-title=""><i class="fa fa-fw fa-google-plus"></i></a></li>
                     <li><a href="https://www.linkedin.com/company/miracle-software-systems-inc" target="_blank" class="social-linkedin" data-toggle="tooltip" title="" data-original-title=""><i class="fa fa-linkedin"></i></a></li>
                     <li><a href="https://www.flickr.com/photos/team_miracle" target="_blank" class="social-flickr" data-toggle="tooltip" title="" data-original-title=""><i class="fa fa-flickr"></i></a></li>
                     <span><a href="https://www.youtube.com/c/Team_MSS" target="_blank" class="social-youtube" data-toggle="tooltip" title="" data-original-title=""><i class="fa fa-youtube-play"></i></a><span>
                  </ul>
               </div>
         ...
         <div class="row">
            ...
            <p class="methodText">
              For more information regarding our Quality Assurance and Quality Engineering offerings please reach out to <a href="mailto:qa@miraclesoft.com" class="linkText"><strong> qa@miraclesoft.com</a></strong>
            </p></div>
