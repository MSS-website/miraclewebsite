...
<html lang="en">
    ...
    <![endif]-->
        ...
        <link href="<?= AMAZON_URL ?>/images/favicon.ico" rel="shortcut icon">
         ...
         /* your image */
         url("<?= AMAZON_URL ?>/images/banners/colud-computing.png");
         -webkit-background-size: cover;
         -moz-background-size: cover;
         -o-background-size: cover;
         background-size: cover;
            ...
            <div class=" container">
                ...
                <div class="row">    
                    <div class="col-sm-7 text-left">  
                        <br><br>
                        <h1 class="micro "><font color="#fff"><strong>Cloud Services</strong></font></h1>
                    ...
                    <div class="col-sm-5 text-right">
                      ...
                      <li>
                        ...
                        <li class="active">Cloud Services
                        </li>
                    </ul>
                    </div>
                </div><br>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a data-toggle="tab" href="#Models">Models</a>
                        </li>
                        <li>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="overview">
                            ...
                            <p class="methodText">
                                <strong>Some of the advantages of the cloud are :</strong>
                            </p>
                             <div class="container">
                            <div class="col-sm-12">
                            
                            <ul class="methodText">
                                <li>Implement new IT systems within days with little (or) no up-front investments required
                                </li>
                                <li>Access services from anywhere through the internet over a multitude of user devices
                                </li>
                                <li>Easily expand your infrastructure on-demand based on the needs of your organization
                                </li>
                                <li>Become a more agile, connected and responsive enterprise
                                </li>
                            </ul>
                            </div>
                            </div>
                            <p>
                            <p class="methodText">
                                For more information regarding <strong>Cloud Services</strong>, contact us at <a class="linkText" href="mailto:cloud@miraclesoft.com"><strong style="text-decoration: underline">cloud@miraclesoft.com</strong></a>
                            </p><br>
                            <br>
                        </div>
                        ...
                        <div class="tab-pane" id="Services">
                            ...
                            <p class="methodText">
                                Contact us today at <a class="linkText" href="mailto:cloud@miraclesoft.com"><strong style="text-decoration: underline">cloud@miraclesoft.com</strong></a>, and our teams will help you in identifying the right service model for you. Our proven methodologies will help us to evaluate your IT and Business assets and give you the best possible strategy for the transition into the cloud. User Guides, Best Practices and Standards given by our teams will all help in the process which we guide you through the configuration, setup, build and support phases.
                            </p><!--End to the copy-->
                            <p class="methodText">
                                <strong>Our services for the cloud include,</strong>
                            </p>
                            <div class="container">
                            <div class="col-sm-12">
                             <ul class="methodText">
                                <li>Migrating your environment to the Cloud
                                </li>
                                <li>Developing/Deploying/Supporting Applications in the Cloud
                                </li>
                                <li>Architecture and Consulting Services for the Cloud
                                </li>
                                <li>Deploying/Supporting Servers and OS Instances on clouds such as Amazon EC2
                                </li>
                                <li>Integrating On-Premise Applications with the Cloud
                                </li>
                                <li>API Management Services
                                </li>
                            </ul><br>
                            </div>
                            </div>
