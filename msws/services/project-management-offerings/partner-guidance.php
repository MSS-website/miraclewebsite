            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Project Guidance and Support</h1>
                  </div>
                  <div class="col-sm-6 text-right">
                     ...
                     <ul class="breadcrumb pull-right">
                        ...
                        <li class="active">Project Guidance</li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                  <br>
                  <p class="methodText">In	the	world	of	IT,	it’s	not	easy	figuring	out	what’s	next,	which	direction	to	take,	or	
who	has	the	best	solution	to	meet	your	needs.	Even	in	the	world	of	Portfolio	and	
Project	Management	(PPM),	there	are	decisions	to	be	made	such	as,		</p>
                  <div class="container">
                       <div class="col-sm-12">
                       <ul class="methodText">
                     <li>What	services	should	I	partner	source?	</li>
                     <li>How	can	I	augment	my	staff?	</li>
                     <li>What	methodology	should	I	use?	</li>
                     <li>How	can	I	decide	what	tools	I	should	use?	</li>
                     <li>What	can	I	automate?	</li>
                  ...
                  <p class="methodText">
                     Those	 are	 some	 REAL	 challenges	 that	 companies	 just	 like	 yours	 have	 turned	 to	
Miracle	 for	 assistance.	 We	 are	 IN	 this	 space	 every	 day	 and	 have	 a	 practice	
devoted	to	PPM.	
                  </p>
                  ...
                  <div class="row">
             <div class="col-sm-12">
               <img class="img-responsive" src="<?= AMAZON_URL ?>/images/pmo/ppm-pracrice.png"></img>
             </div>
          </div>
          
          
                  <p class="methodText">
                   So	let	us	be	your	partner	in	the	PPM	space.	We’ll	do	whatever	is	needed	to	clear	
the	obstacles	and	get	you	back	to	focusing	on	YOUR	business	while	getting	your	
projects	done!		
                     </p>
                  </div>
            </div>
          ...
          <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
               ...
               <a href="#" class="list-group-item">
                  <div >
                     <center><strong><font size="3%!important" color="#00aae7">&nbsp;Partner	Guidance
...
Solutions</strong> reach	out	to <strong><a href="mailto:pmo@miraclesoft.com" class="linkText">pmo@miraclesoft.com.</a></strong></p>
</div>
