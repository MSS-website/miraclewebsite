            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Software	Solutions	for	PPM</h1>
                  </div>
                  <div class="col-sm-6 text-right">
                     <ul class="breadcrumb pull-right">
                       ...
                       <li><a href="../project-management-offerings">PMO</a></li>
                        <li class="active">Software	Solutions</li>
                     </ul>
                  </div>
               </div>
            </div>
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                  <br>
                  <p class="methodText">
                     Miracle	 partners	 with	 the	 best	 in	 class	 PPM	 providers	 in	 order	 to	 offer	 our	
customers	the	best	options	available	to	address	their	project	needs.	To	make	sure	
you	are	getting	the	most	out	of	your	PPM	software	we	also	provide	the	following	
services,
                     </p>
             ...
             <div class="row">
                    ...
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                        <img src="<?= AMAZON_URL ?>/images/pmo/SolutionDicovery.png" alt="logo" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
                        <p><strong>Solution	Discovery	</strong></p>
                        <p class="methodText">Find	out	which	solution	meets	all	your	requirements	through	product	evaluations	
and	workshops.	We	can	also	do	demos	so	that	the	requirements	your	team	has	
are	fully	addressed.	
	</p>
                    </div>
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                        <br><img src="<?= AMAZON_URL ?>/images/pmo/Configure.png" alt="logo" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
                        <p><strong>Configuration</strong></p>
                        <p class="methodText">As	a	partner,	we’ve	had	training	on	all	these	tools	and	know	the	ins	and	outs	of	
administration.	 Let	 us	 assist	 you	 in	 configuring	 to	 your	 needs	 and	 making	 the	
modifications	that	address	your	environment.	
	</p>
                    </div>
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                       <br> <img src="<?= AMAZON_URL ?>/images/pmo/Training.png" alt="logo" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
                        <p><strong>Training		</strong></p>
                        <p class="methodText">We	can	quickly	train	your	teams	on	how	to	get	the	most	out	of	the	solution.	We	
know	that	the	quicker	your	team	can	get	up	to	speed	on	the	solution,	the	faster	
your	projects	get	done	-	no	time	is	wasted	here.				
	</p>
                    </div>
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                          <br>
                        <img src="<?= AMAZON_URL ?>/images/pmo/Support.png" alt="logo" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
                        <p><strong>Ongoing	Support	</strong></p>
                        <p class="methodText">Need	help	with	a	question?	We’re	here	to	assist	you	with	whatever	might	come	
up.	Including	the	ability	to	have	onsite	and	offshore	resources	to	not	only	use	the	
tool,	 but	 also	 lead	 your	 projects.	 This	 will	 give	 your	 internal	 teams	 a	 go-to	
resource	to	help	guide	them	and	provide	real-world	examples.				
	</p>
                    </div>
         ...
         <div class="col-sm-12">
            <p class="methodText"> For	more information regarding <strong>Miracle’s Portfolio and Project Management
Solutions</strong> reach out to <a class="linkText" href="mailto:pmo@miraclesoft.com"><strong>pmo@miraclesoft.com</strong></a>  </p> 
         ...
         <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
               ...
               <a href="../project-management-offerings" class="list-group-item-1">
                  <div>
                     <center><strong><font size="3%!important" color="#fff"  onMouseOut="this.style.color='#fff'" onMouseOver="this.style.color='#b7b2b3'">&nbsp; Project	Management	Solutions		
               ...
               <a href="partner-guidance.php" class="list-group-item">
                  <div >
                     <center><strong><font size="3%!important" color="#000">&nbsp;Partner	Guidance
               ...
               <a href="find-resource.php" class="list-group-item">
                  <div>
                     <center><strong><font size="3%!important" color="#000">&nbsp; Finding	Resources
                ...
                <a href="#" class="list-group-item">
                  <div>
                     <center>
                     <strong><font size="3%!important" color="#00aae7">&nbsp; Software	Solutions
