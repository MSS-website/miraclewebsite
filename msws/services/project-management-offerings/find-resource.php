            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Finding	the	right	resources</h1>
                  </div>
                  <div class="col-sm-6 text-right">
                     <ul class="breadcrumb pull-right">
                        <li><a href="../../">Home</a></li>
                        <li><a href="../">Services</a></li>
                         <li><a href="../project-management-offerings">PMO</a></li>
                        <li class="active">Finding	resources</li>
                     </ul>
                  </div>
               </div>
            </div>
      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                  <br>
                  <p class="methodText">Everybody	 needs	 project	 management.	 Everybody	 needs	 business	 analysis.	
Everybody	 needs	 program	 management.	 Certainly,	 everybody	 needs	 a	 great	
Scrum	Master	too.	Why	try	to	find	resources	to	fill	these	needs	on	your	own	when	
Miracle	has	been	filling	these	functions	and	others	for	the	past	20+	years?		</p>
                
                
                <p class="methodText">
                   We	know	that	quality	matters.	We	know	that	your	specific	requirements	matter.	
We	 also	 know	 that	 time	 is	 a	 commodity.	 So	 let	 us	 fill	 needs	 with	 our	
quality	resources	that	will	meet	all	your	needs,	and	do	it	all	at	the	speed	of	
thought!	
                </p>
                
                <p class="methodText">
                   Our	 resources	 can	 also	 be	 anywhere	 you	 need	 them	 to	 be	 including	 onsite,	
offshore,	or	anywhere	in	between.	Here	are	some	of	the	benefits	of	our	resource	
sourcing	model,		
                </p>
               </div>
              ...
              <div class="row">
                    ...
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                          <br>
                        <img src="<?= AMAZON_URL ?>/images/pmo/Onsite-1.png" alt="logo" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
                        <p><strong>Onsite	Resources</strong></p>
                        <p class="methodText">They’re	in	your	facility,	collaborating	with	your	teams	and	driving	your	projects	to	
success.	 They’re	 on	 your	 schedule	 and	 having	 face-to-face	 discussions	 with	
whoever	 is	 needed.	 Experience	 and	 quality	 are	 a	 given.	 They’ll	 have	 the	
background	you	want,	in	the	industry	you	reside,	and	have	already	implemented	
the	solution	you’re	embarking	on.	They’ll	fit	in	so	well,	you’ll	think	they	were	your	
own	resources!	
	</p>
                    </div>
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                          <br>
                        <img src="<?= AMAZON_URL ?>/images/pmo/Offshore-1.png" alt="logo" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
                        <p><strong>Offshore	Resources</strong></p>
                        <p class="methodText">They’ll	be	with	your	offshore	teams	driving	them	to	success.	They	can	still	be	on	
whatever	 schedule	 is	needed,	 but	this	should	be	aligned	with	the	teams	they’re	
located	 with.	 These	 resources	 bring	 US	 based	 experience	 to	 the	 table,	 while	
working	 offshore.	 Additionally,	 there’s	 also	 a	 significant	 cost	 savings	 to	 be	
achieved	using	this	model.				
                ...
                <div style="margin-top:5px;" class="row">
                    <div class="col-sm-12">
                       <div class="col-sm-2">
                          <br>
                        <img src="<?= AMAZON_URL ?>/images/pmo/hybrid.png" alt="logo" class="img-responsive">
                    </div>
                    <div class="col-sm-10">
                        <p><strong>Hybrid	Resources</strong></p>
                        <p class="methodText">Need	resources	working	around	the	clock	to	get	your	projects	done?	Everything	is	
possible	with	our	teams.	Why	not	try	a	hybrid	model	that	allows	resources	to	be	
managed	by	an	onsite	project	manager	and	then	let	them	hand	off	to	an	offshore	
PM	who	will	manage	an	offshore	team	who	will	keep	progress	moving.			
	</p>
                    </div>
        ...
        <br>
            ...
            <div class="row">
               <div class="col-sm-12">
                  <p class="methodText">For more information regarding <strong>Miracle's	Portfolio and Project Management	Solutions</strong> reach out to <a class="linkText" href="mailto:pmo@miraclesoft.com"><strong>pmo@miraclesoft.com</strong></a>  </p>
               </div>
            </div>
         </div>
        <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
              ...
              <a href="../project-management-offerings" class="list-group-item-1">
                  <div>
               ...
               <a href="#" class="list-group-item">
                  <div>
                     <center><strong><font size="3%!important" color="#00aae7">&nbsp; Finding	Resources
