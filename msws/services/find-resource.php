...
PM	who	will	manage	an	offshore	team	who	will	keep	progress	moving.			
        ...
        <br>
            ...
            <div class="row">
               <div class="col-sm-12">
                  <p class="methodText"><em>For more information regarding <strong>Miracle’s	Portfolio and Project Management	Solutions</strong> reach out to <a class="linkText" href="mailto:pmo@miraclesoft.com"><strong>pmo@miraclesoft.com</strong></a>  </em></p>
               </div>
            </div>
         </div>
        <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
              ...
              <a href="../pmo/" class="list-group-item-1">
                  <div>
    ...
    padding: 2px 16px;
         ...
         url('<?= AMAZON_URL ?>/images/pmo/atlanticus-financial.png');
              ...
              <span data-toggle="collapse">
                    <div class="widget">
                   <a href="mailto:pmo@miraclesoft.com" > <div class="widget-content widget-hover themed-background text-light-op">
