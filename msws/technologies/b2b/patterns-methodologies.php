      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                  <br>
                  <p class="methodText">Through <strong>Miracle’s B2B CoE</strong>, our team has gained strong implementation capabilities using industry 
...
error handling frameworks.                    </p>
               ...
               <div class="row">
                   <div class="col-sm-6">
                <img src="<?= AMAZON_URL ?>/images/b2b/B2B_app_2.1.png" alt="image" class="img-responsive">
                </div>
                <div class="col-sm-6">
                <img src="<?= AMAZON_URL ?>/images/b2b/B2B-partner.png" alt="image" class="img-responsive">
            </div>
             ...
             <br>
              <div class="row">
            <div class="col-sm-12">
              <center>  <img src="<?= AMAZON_URL ?>/images/b2b/B2BFinal.png" alt="image" class="img-responsive"></center>
            </div>
            </div><br>
          <div class="row">
            <div class="col-sm-12">
                <img src="<?= AMAZON_URL ?>/images/b2b/Typical_B2B_Pattners_1.png" alt="image" class="img-responsive">
            </div>
         </div><br>
          <div class="row">
          <div class="col-sm-12">
...
and methodologies for analysis, architecture, design, development, deployment and 24/7 support.  </p>
         ...
         <div class="row">
            ...
            <div class="col-sm-6">
                <img src="<?= AMAZON_URL ?>/images/b2b/B2B_Methodologies_Implementaion_Team_V1.0.png" alt="image" class="img-responsive">
           </div>
           <div class="col-sm-6">
                <img src="<?= AMAZON_URL ?>/images/b2b/B2B_Methodologies_On-going_V1.0.png" alt="image" class="img-responsive">
            </div>
