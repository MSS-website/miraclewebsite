        ...
        <style>
            ...
            .section_bg{
                background: 
                    ...
                    /* your image */
                    url(" <?= AMAZON_URL ?>/images/banners/application-integration.png");
                -webkit-background-size: cover;
                -moz-background-size: cover;
                -o-background-size: cover;
                background-size: cover;
            ...
            <div class=" container">
                ...
                <div class="row">    
                    <div class="col-sm-7 text-left">  
                        <br><br>
                        <h1 class="micro "><font color="#fff"><strong> SOA, Connectivity and Middleware</strong></font></h1>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="overview">
                            ...
                            <div class="row">
                                <div class="col-sm-3 center">
                                    <center>
                                    <img alt="Responsive image" class="img-responsive" src="<?= AMAZON_URL ?>/images/services/app-integration.png" alt="App-Integration" title="App Integration"><br>
                                    </center>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3 class="heavy">
                                ...
                                <div class="col-sm-3 center">
                                    <center>
                                    <img alt="Responsive image" class="img-responsive" src="<?= AMAZON_URL ?>/images/services/cloud-integration.png" alt="Cloud-integration" title="Cloud Integration"><br>
                                    </center>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3 class="heavy">
                                ...
                                <div class="col-sm-3 center">
                                    <center>
                                    <img alt="Responsive image" class="img-responsive" src="<?= AMAZON_URL ?>/images/services/process-integration.png" alt="Process-Integration" title="Process Integration"><br>
                                    </center>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3 class="heavy">
                                ...
                                <div class="col-sm-3 center">
                                    <center>
                                    <img alt="Responsive image" class="img-responsive" src="<?= AMAZON_URL ?>/images/services/mobile-integration.png" alt="Mobile-Integration" title="Mobile Integration"><br>
                                    </center>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <h3 class="heavy">
                       ...
                       <div class="col-sm-12">
                        <ul class="methodText">
                                ...
                                <div class="col-sm-6">
                                    <br>
                                    <img class="img-responsive" src="<?= AMAZON_URL ?>/images/services/integration-framework.png" alt="Integration-Framework" title="Integration Framework">
                                </div>
                            </div><br>
                            <br>
                        </div>
                        <div class="tab-pane" id="SOA">
                            ...
                            <p class="methodText">
                                A SOA approach gives the organization better efficiency, agility and flexibility at a reduced cost. In the past we had Point-to-Point connectivity with tightly associated applications and tough-coded integration which are now replaced by new mechanisms. Enterprises need to become nimble and agile in order to constantly change in a rapidly growing marketplace. SOA enables you to obtain complete integration with lesser efforts, reduced costs and increased efficiency.
                            </p>
                            <p class="methodText">
