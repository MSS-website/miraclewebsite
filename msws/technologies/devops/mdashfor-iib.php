...
<html lang="en">
   <head>
      ...
      <meta name="description" content="Our teams can help you realize the value of a true DevOps culture and implement a scalable framework that can be implemented across your teams.">
  ...
  <?php include '../../header.php';?>
   <body>
      <section id="services" >
       ...
       <section id="services" class="container">
         ...
         <div class="col-sm-9">
             ...
             <h3 class="heavy">Introduction to <font color="#232527"><strong>mDash</strong></font> </h3>
            
            
             <p class="methodText pull-left"><strong>mDash for IIB </strong> is a custom built, Open Source, Self Service, DevOps Web Portal for managing the lifecycle of IBM Integration Bus artifacts. Through this dashboard actions like build, deploy and testing of their work in various environments is easy and efficient to use. Along with role based access it provides features such as configuring code repositories and IIB environments, decommissioning BARs and rolling then back as well.    
          ...
          <div class="row">
               <div class="col-sm-12">   
                ...
                <div class="row">
                       ...
                       <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="<?= AMAZON_URL ?>/images/devops/Image11.png" alt="Image1"><center>
                         
                         <div class="">
                         
                          <h6 style="color:#232527 !important; line-height: 1.3;">Higher	Visibility into	<br>Development	Cycle</h6>
                        </div>
                       </div>
                       ...
                       <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="<?= AMAZON_URL ?>/images/devops/Image12.png" alt="Image3"><center>
                         
                         <div class="">
                         
                          <h6 style="color:#232527 !important; line-height: 1.3;">Governance over Promote and Rollback</h6>
                        </div>
                       </div>
                        <div class="col-sm-4">
                         <center><img class="img-reaponsive" src="<?= AMAZON_URL ?>/images/devops/Image13.png" alt="Image2"><center>
                         
                         <div class="">
                         
                          <h6 style="color:#232527 !important; line-height: 1.3;">Reduced Time for<br>Integration Results</h6>
                        </div>
                       </div>
             ...
             <div class="col-sm-5">
             <div class="pro">
             <p class="methodText"><center><strong>Build, Deploy, Test and Promote BARs</strong></center></p>
             </div>
             </div>
               <div class="col-sm-3">
               <div class="pro1">
               <p class="methodText"><center><strong>Rollback</strong></center></p>
               </p>
             </div>
             </div>
             <div class="col-sm-4">
             <div class="pro5">
               <p class="methodText"><center><strong>Configure	Environments</strong></center></p>
               </p>
             </div>
             </div>
             </div>
             ...
             <div class="col-sm-2">
             <div class="pro2">
             <p class="methodText"><center><strong>Decommission</strong></center></p>
             </div>
             </div>
               <div class="col-sm-5">
               <div class="pro3">
               <p class="methodText"><center><strong>Track Artifact	and	Build History</strong></center></p>
               </p>
             </div>
             </div>
             <div class="col-sm-5">
             <div class="pro4">
             <p class="methodText"><center><strong>RBAC	and	SSO	for	Users </strong></center></p>
             </div>    
             </div>
             </div>
          <br><br>-->
         ...
         <div class="row">
               <div class="col-sm-12">     
                 <h3 class="heavy">mDash  <font color="#232527"><strong>Architecture</strong></font></h3>     
                   <p class="methodText">
                    mDash for IIB was built on top of MEAN(Mongo DB, Express JS, Angular JS and Node JS) using Open Source technologies such as Jenkins, Artifactory and SVN/Git behind the scenes. This means that the customers can focus on their development flow rather than the intricacies of Jenkins and other DevOps tools.
                   </p>
               </div>
         </div><br>
         <div class="row">
               <div class="col-sm-12">     
                   <img class="img-responsive" src="<?= AMAZON_URL ?>/images/devops/DevOps22.png"></img>
               </div>
         </div>
            ...
            <div class="row" >
              <br>
              <div class="col-sm-4">
             <center> <img src="<?= AMAZON_URL ?>/images/devops/mean_100.png" class="img-responsive"></img></center>
           <center>  <h5 class="heavy">MEAN based	Tech Stack</h5></center>
             <center> <p class="greyText">Open	Source	and	Light	Weight	Implementation</p></center>
              
              </div>
              <div class="col-sm-4">
              <center><img src="<?= AMAZON_URL ?>/images/devops/Artifactory_100.png" class="img-responsive"> </img></center>
               <center><h5 class="heavy">Jenkins	and	Artifactory</h5></center>
               <center><p class="greyText">Open	Source Build Server	and Artifact Store for	mDash</p></center>
               
              
              </div>
              <div class="col-sm-4">
              <center><img src="<?= AMAZON_URL ?>/images/devops/IBM_100.png" class="img-responsive"></img></center>
              <center><h5 class="heavy">For IBM	Integration	Bus</h5></center>
              <center><p class="greyText">Automates	the	development	lifecycle	for	IIB	Artifacts</p></center>
    ...
    <br>
            <div class="row">
            <div class="col-sm-6">
                <img class="img-responsive" src="<?= AMAZON_URL ?>/images/devops/mdash-bottom-image.jpg" alt="mdash">
            </div>
            <div class="col-sm-6 " style="margin-top:-34px;"><br>
            <h5 class="heavy" style="line-height:1.3 ;">DevOps with IBM Integration Bus and mDash for Leading Healthcare Firm</h5>
               <p class="methodText">
            We designed mDash for IIB, an application that orchestrates - build, test and deploy jobs while also managing rollbacks, decommissions and promotions by integrating with SVN, Jenkins, Artifactory and IIB Servers securely.
             </p>
          <a href="http://www.miraclesoft.com/library/CaseStudy/devops-ibm-integration-bus-mdash-leading-healthcare-firm.php" target="_blank"> <button type="button" class="btn btn-primary btn-sm">Read More</button></a>
    ...
    <p class="methodText"> <br>For more information about <strong>mDash for IIB </strong>reach out to <a href="mailto:devops@miraclesoft.com" style="text-decoration:none;"> <strong>devops@miraclesoft.com</strong></a>  
</p>
    ...
    padding: 2px 16px;
             ...
             <div>
              ...
              <span data-toggle="collapse">
                    <div class="widget">
                   <a href="mailto: devops@miraclesoft.com" > <div class="widget-content widget-hover themed-background text-light-op" style="margin-top:5px;">
