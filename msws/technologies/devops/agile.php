...
<html lang="en">
   <head>
      ...
      <meta name="description" content="Tomorrow’s enterprises need to be able to deliver functionality and experiences to their consumers on time at the highest quality. To achieve this a certain level of automation and collaboration need to be put in place to ensure productivity.">
            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Tomorrow's Agile Enterprise</h1>
                      <br>
                  </div>
                  <div class="col-sm-6 text-right">
                     <ul class="breadcrumb pull-right">
                        ...
                        <li class="active">Agile Enterprise</li>
...
automation and collaboration need to be put in place to ensure productivity.</p>
                ...
                <div class="col-sm-12">
                        ...
                        <h1 class="heavy">Enabling Collaboration at speed</h1>
...
developer cannot do it all</font> <strong>– you need a team to deliver, and a collaborative one</strong>.</p>
               ...
               <div class="row">
                   <div class="col-sm-12">
                <img src="<?= AMAZON_URL ?>/images/devops/DevOps_1.PNG" alt="devops" class="img-responsive">
                </div>
             ...
             <br>
              <div class="row col-sm-12">
                        ...
                        <h1 class="heavy">Continuous Ecosystem</h1>
                        
                        <p class="methodText">To continuously deliver results, your teams need to fail fast, be able to iterate
rapidly and react to feedback from the business. Through a strong
CICD(Continuous Integration and Continuous Delivery) pipeline you can enable
your teams to do exactly that.</p>
                    
                    
                    </div>
                    <div class="row col-sm-12">
                      
                         <h4><font color="#2368a0"><strong>Continuous Integration</strong></font></h4>
                        
                        <p class="methodText">A development practice that encourages teams to frequently integrate code into
a shared repository to reduce bug fix costs by early detection to help improve
agility.</p>
                    ...
                    <div class="row">
                   <div class="col-sm-12">
                <img src="<?= AMAZON_URL ?>/images/devops/DevOps_2.PNG" alt="devops" class="img-responsive">
                </div>
                </div>
                    <div class="row col-sm-12">
                        <h4><font color="#2368a0"><strong>Continuous Delivery</strong></font></h4>
                        <p class="methodText">An extension approach of CI which makes every build releasable through
automation which then promotes frequent and high quality releases.</p>
         ...
         <div class="col-sm-3 sidebar pull-right">
            ...
            <div class="list-group">
               ...
               <a href="#" class="list-group-item">
                  <div>
                     <center>
                     <strong><font size="3%!important" color="#00aae7">&nbsp; An Agile Enterprise	
                     </font></strong>
                     <center>
                  </div>
               </a>
