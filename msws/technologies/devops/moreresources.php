...
<meta name="description"
	content="Miracle is a Thought Leader is the space of Big Data, Advanced Analytics, BI/DWH, Database Management and Cognitive Science">
<meta name="author" content="">
<title>More Resources -Devops| Miracle</title>
    ...
    <?php
				...
				if (isset ( $_POST ['btnLoginSubmit'] )) {
					try {
						...
						$data = array (
								"LoginId" => "$rloginId",
								"Password" => "$rpassword",
								"Authorization" => base64_encode ( SERVICE_AUTHORIZATION ) 
						);
						...
						if (1 !== $curl_response) {
							...
							if ($myArray ['IsAuthenticate']) {
								...
								if ($myArray ['ResultString'] == 'Valid') {
									...
									$sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone,AccessType)   " . " VALUES(:rObjectId,:rRefId,:rfirstname,:rlastName,:rorganization," . ":rdesignation,:remail,:rphone,'I')";
				...
				if (isset ( $_POST ['btnSignUpSubmit'] )) {
					...
					try {
						...
						$sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " . " VALUES(:rObjectId,:rRefId,:rfirstname,:rlastName,:rorganization," . ":rdesignation,:remail,:rphone)";
...
.tinted-image {
	background: /* top, transparent red */ linear-gradient( rgba( 0, 0, 0,
		0.55), rgba( 0, 0, 0, 0.55)), /* your image */
         url("<?= AMAZON_URL ?>/images/devops/devops-header.jpg");
	...
	<section id="services" class="container">
		<div class="row">
			<div class="col-sm-9">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="heavy">More Resources</h2>
						<p class="methodText">Miracle is a Thought Leader is the space of
							Big Data, Advanced Analytics, BI/DWH, Database Management and
							Cognitive Science. Through our digital library we provide the
							world with use cases, solution architectures and more to help
							enable you to take the next step.</p>
					</div>
					<br>
					<div class="col-sm-12 hover1">
						...
						<iframe src="https://player.vimeo.com/video/190865491"
							width="100%" height="380" frameborder="0" webkitallowfullscreen
							...
							<div class="col-sm-12"
								...
								<div class="tab-content">
									 <div class="tab-pane active" id="sign-in-for-access">
												...
												<div class="col-sm-6">
													<div class="form-group">
														<input class="form-control" placeholder="Email*"
															name="email" id="email" required="required" type="text"
												...
												<div class="col-sm-12">
													<div class="alert alert-danger" style="display: none"
														...
														<button type="button" class="close"
															onclick="closeErrorMsg()" aria-label="Close">
												...
												<div class="col-sm-12">
													<div class="form-group">
														<button class="btn btn-primary col-sm-12"
															id="btnSignUpSubmit" name="btnSignUpSubmit" tabindex="12"
										...
										<p class="methodText greyText">The given information will not
											be used or be distributed to any sources and will be used
											only for User Authentication. Miracle has copyrights and is
											authorized to use and circulate all the resources which are
											being provided to you.</p>
										<br>
									...
									<div class="tab-pane" id="emplyolee-sign-in">
										...
										<form id="employeeLoginForm" method="post" action="#">
											<p class="methodText greyText">You must be a Miraclite to
												gain access to this. Please validate yourself using your
												Miracle credentials for further access.</p>
											<br>
											<div class="row ">
												<div class="col-sm-6">
													<div class="form-group">
												...
												<div class="col-sm-6">
													<div class="form-group">
														...
														<button type="submit" name="btnLoginSubmit"
															id="btnLoginSubmit" class="btn btn-primary col-sm-12"
															data-loading-text="<i  class='fa fa-spinner fa-spin '>
															</i> loading..." style="margin-left:1px;"
															tabindex="3">Login
														</button>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<p class="methodText">Learn more about how Miracle’s teams have
							helped organizations improve their test processes through
						...
						<a class="btn btn-danger" href="#scroller" data-slide="prev"><i
							...
							href="#scroller" data-slide="next"><i class="icon-angle-right"></i></a>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div id="scroller" class="carousel slide">
							<div class="carousel-inner">
											...
											<div class="portfolio-item">
												...
												<div class="card ">
													<div class="embed-responsive embed-responsive-16by9">
														...
														<a target="_blank"
															href="http://www.miraclesoft.com/webinars/mulesofts-anypoint-platform-hybrid-integration">
															<img src="<?= AMAZON_URL ?>/images/devops/mulesoft.jpg"
															class="img-responsive" alt="Hybrid Integration">
														</a>

													</div>
													<a class="linkText1" target="_blank"
														href="http://www.miraclesoft.com/webinars/mulesofts-anypoint-platform-hybrid-integration">
														<div class="container"
															style="background-color: #eee; margin-top: -5px;">

															<p>
															
															
															<center>
																<strong>MuleSoft's Anypoint Platform - Hybrid
																	Integration </strong>
															</center>
															</p>
															<br>
										...
										<div class="col-sm-4">
											...
											<div class="portfolio-item">
												...
												<div class="card">
													<div class="embed-responsive embed-responsive-16by9">
														<a target="_blank"
															href="http://www.miraclesoft.com/webinars/understanding-continuous-integration-ibm-integration-bus-deployments">
															<img
															src="<?= AMAZON_URL ?>/images/devops/integration.jpg"
															class="img-responsive" alt="Integration">
														</a>
													...
													<a class="linkText1" target="_blank"
														...
														<div class="container"
															...
															<center>
																<strong>Understanding Continuous Integration for your
																	IBM Integration Bus Deployments</strong>
															</center>
															</p>
														</div>
													</a>
											...
											<div class="portfolio-item">
												...
												<div class="card">
													<div class="embed-responsive embed-responsive-16by9">
														...
														<a target="_blank"
															href="http://www.miraclesoft.com/webinars/leverage-automated-testing-accelerate-digital-business-strategy">
															<img src="<?= AMAZON_URL ?>/images/devops/testing.jpg"
															class="img-responsive" alt="testing">
														</a>
													</div>
													<a class="linkText1" target="_blank"
														href="http://www.miraclesoft.com/webinars/leverage-automated-testing-accelerate-digital-business-strategy">
														<div class="container"
															...
															<center>
																<strong>Leverage Automated Testing to accelerate your
																	Digital Business Strategy</strong>
															</center>
															</p>
														</div>
													</a>
								...
								<!---   <div class="portfolio-item">
                                                 ...
                                                 <div class="card">
                                                 <div class="embed-responsive embed-responsive-16by9"> 
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=22"><img src="images/enabling-digital.png" alt="DBA" class="img-responsive"></a>
							...
							<!---<div class="portfolio-item">
                                             ...
                                             <div class="card">
                                                  <div class="embed-responsive embed-responsive-16by9">
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=23"><img src="images/enabling-part2.png" alt="Discovery Solution" class="img-responsive"></a>
						...
						<!--- <div class="portfolio-item">
                                                 ...
                                                 <div class="card">
                                                 <div class="embed-responsive embed-responsive-16by9"> 
                                                  <a class="linkText1" target="_blank"  href="http://www.miraclesoft.com/events/webinar-after.php?eventId=24"><img src="images/enabling-part3.png" alt="SAP HANA" class="img-responsive"></a>
...
.btn-primary {
	...
	border-color: #00aae7 !important;
					...
					<a href="index.php" class="list-group-item-1">
						<div>
							<center>
								<strong><font size="3%!important" color="#fff"
									...
									onMouseOver="this.style.color='#b7b2b3'">&nbsp; DevOps and
										Automation </font></strong>
							</center>
						</div>
					</a> <a href="service-offerings.php" class="list-group-item">
						<div>
							<center>
								<strong><font size="3%!important" color="#000">&nbsp;Our Service
										Offerings </font></strong>
							</center>
						</div>
					</a> <a href="mdashfor-iib.php" class="list-group-item">
						<div>
							<center>
								<strong><font size="3%!important" color="#000">&nbsp; mDash for
										IIB </font></strong>
							</center>
						</div>
					</a> <a href="agile.php" class="list-group-item">
						<div>
							<center>
								<strong><font size="3%!important" color="#000">&nbsp; An Agile
										Enterprise </font></strong>
								<center>
						
						</div>
					</a> <a
						href="http://www.miraclesoft.com/services/quality-assurance/"
						class="list-group-item" target="_blank">
						<div>
							<center>
								<strong><font size="3%!important" color="#000">&nbsp; Continuous
										Testing </font></strong>
								<center>
						...
						<div>
							<center>
								<strong><font size="3%!important" c color="#00aae7">&nbsp; More
										Resources </font></strong>
								<center>
...
#check {
	background: /* top, transparent red */ linear-gradient( rgba( 0, 0, 0,
		0.65), rgba( 0, 0, 0, 0.65)), /* your image */
         url("<?= AMAZON_URL ?>/images/devops/interface.png");
	-webkit-background-size: cover;
	-moz-background-size: cover;
	-o-background-size: cover;
	background-size: cover;
...
.linkText1 {
	color: #232527 !important;
								...
								<center>
									<a
										href="http://www.miraclesoft.com/library/CaseStudy/automated-scripting-data-load-fucntions.php">
										<h3 class="heavy"></h3>
										<p>
											<font size="3px" color="#fff" >
<strong>Automated Scripting and Data load Functions for Global Carpet Retailer </strong></font>
										</p>
										<br>
									</a>
								</center>
					...
					<span data-toggle="collapse">
						<div class="widget">
							<a href="mailto:sap@miraclesoft.com">
								<div
									class="widget-content widget-hover themed-background text-light-op"
									style="margin-top: 7px;">
									<center>
										<strong><font color="#ffffff"> Contact Us</font></strong>
									</center>
								</div>
							</a>
						</div>
		...
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<p class="methodText">
					For more information about <strong>Miracle's DevOps and
						Automation Offerings</strong> reach out to <strong><a
						href="mailto:devops@miraclesoft.com" class="linkText">devops@miraclesoft.com</a></strong>
				</p>
			</div>
