   ...
   <body>
      ...
      <section id="services" class="container">
            ...
            <div class="row">
               ...
               <div class="col-sm-6">
                  <p class="methodText">
                     ...
                     <li>AI & Cognitive Services (Bot Services)</li>
                  </ul>
                       </div>
                       </div>
         ...
         <div class="row">
            ...
            <p class="methodText">
               For more information regarding <strong>Miracle’s Microsoft Services portfolio</strong> please reach out to <strong><a href="mailto:microsoft@miraclesoft.com" class="linkText">microsoft@miraclesoft.com</a></strong>
            </p></div>
