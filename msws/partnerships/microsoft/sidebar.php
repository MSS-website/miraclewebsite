...
<html lang="en">
            ...
            <div class="container ">
               <div class="row">
                  ...
                  <div class="col-sm-6 text-left">
                     <h1 class="heavy micro">Microsoft Service Offerings</h1>
                  </div>
      ...
      <section id="services" class="container">
         ...
         <div class="col-sm-9">
            <div class="row">
               <div class="col-sm-12">
                  <br>
                  <p class="methodText"><strong>Miracle Software Systems, Inc.</strong> is a globally-focused full-services company aligned with Microsoft's Cloud-First, Mobile-First strategy. We transform the businesses of our clients by providing strategic, technology-enabled business solutions.</p>
                  <p class="methodText">We help our clients gain maximum return on investment and competitive advantage through the implementation of enterprise technologies such as Microsoft Azure, SharePoint, Office 365, Dynamics, and Xamarin.
                  </p>
               </div>
            </div>
            <div class="row">
               <div class="col-sm-4">
                  <img src="<?= AMAZON_URL ?>/images/partnerships/microsoft/microsoft_logo.png" class="img-responsive"/>
               </div>
               <div class="col-sm-8">
                  <br>
                  <p class="methodText">We are proud <strong>Gold Microsoft Partners </strong>and have large global team of Microsoft certified professionals in various competencies. We architect, design, and implement industry-focused, integrated solutions leveraging Microsoft technologies across a variety of industries and practice areas. 
                  </p>
               </div>
            </div>
            <div classs="row">
               <img src="<?= AMAZON_URL ?>/images/partnerships/microsoft/newer.png" class="img-responsive">
            </div>
            ...
            <div class="row">
             <div class="col-sm-12">
                <h1 class="heavy">
                  ...
                  <strong>Microsoft Service Offerings</strong>
               </h1>
            ...
            <div class="row">
               <div class="col-sm-6">
                  <p class="methodText">
                     <strong> Strategy Services</strong> 
                  <ul>
                     <li>IT Strategy Roadmaps</li>
                     <li>Application Portfolio Management</li>
                     <li>IT Assessment and Health Check</li>
                     <li>Application Outsourcing Strategy</li>
                     <li>Enterprise Mobile Strategy</li>
                     <li>Cloud Readiness and Strategy</li>
               ...
               <div class="col-sm-6">
                  ...
                  <ul>
                     ...
                     <li>Portals, Collaboration and Productivity</li>
                     <li>ERP & CRM Systems</li>
                     <li>Infrastructure Services and Management</li>
                     <li>BigData, Business Intelligence & Data Services</li>
                     <li>Internet of Things (IoT) Suite</li>
                  </ul>
                  </p>
               </div>
            </div>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
         <div class="col-sm-3 sidebar pull-right nav nav-pills nav-stacked" data-spy="affix" data-offset-top="205">
            <br>
            ...
            <div class="list-group">
               ...
               <a href="#" class="list-group-item-1">
                  <div>
                     <center><strong><font size="3%!important"color="#fff">&nbsp; Microsoft@Miracle
                        </font></strong>
                     </center>
                  </div>
               </a>
               ...
               <div >
                  ...
                  <div class="widget box">
                     <div class="widget-content" id="check" >
                        ...
                        <center>
                           <a href="#">
                              <h3 class="heavy"></h3>
                              <p><font size="3px"color="#fff"><strong>Automated .NET application for National Retailer</strong></font></p>
                           </a>
                        </center>
                     </div>
                  </div>
                  <div class="widget-content  text-dark register-hover">
                     <a class="linkText1" href="http://www.miraclesoft.com/why/sstory8.php" target="_blank">
                        <center><strong><font color="#fff">Read Today</font></strong></center>
                     </a>
                  </div>
                  </a>
               </div>
              ...
              <span data-toggle="collapse" id="menu-button">
                    <div class="widget">
                   <a href="mailto:microsoft@miraclesoft" > <div class="widget-content widget-hover themed-background text-light-op">
         ...
         <div class="row">
            ...
            <p class="methodText">
               For more information regarding <strong>Miracle’s Microsoft Services portfolio</strong> please reach out to <strong><a href="mailto:miraclesoft.com" class="linkText">microsoft@miraclesoft.com</a></strong>
            </p></div>
