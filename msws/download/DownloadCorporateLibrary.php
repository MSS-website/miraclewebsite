...
try{
    ...
    //$conn->selectDatabase();
    //$selectQuery = "SELECT Title,FileName,FilePath,FileType FROM tblCorporateDownloads WHERE Id =$rrefId";
    $selectQuery = "SELECT Title,FileName,FilePath,FileType FROM tblCorporateDownloads WHERE Id =:rrefId";
...
switch ($filetype) {
     case "zip":
        output_file($rootPath, ''.$file_name.'', 'application/zip');
        break;
     case "exe":
      output_file($rootPath, ''.$file_name.'', 'application/octet-stream');
        break;
     case "doc":
      output_file($rootPath, ''.$file_name.'', 'application/msword');
        break;
     case "jpg":
      output_file($rootPath, ''.$file_name.'', 'image/jpg');
        break;
     case "php":
     ...
     case "txt":
       output_file($rootPath, ''.$file_name.'', 'text/plain');
        break;
     case "html":
      output_file($rootPath, ''.$file_name.'', 'text/html');
        break;
     case "png":
