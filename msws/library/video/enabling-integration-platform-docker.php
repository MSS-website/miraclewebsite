...
session_destroy(); 
$data = file_get_contents('http://www.miraclesoft.com/library/video/video-play.php?videoId=237&sesAccessType='.$ses_Access_Type.'&sesVideoId='.$ses_VideoId.'&sesErrMsg='.urlencode($ses_Err_Msg)); 
 echo $data; 
?>