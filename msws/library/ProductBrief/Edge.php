...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=46";
            ...
            try {
              ...
              //  $conn->connectToDatabase();
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(2,46,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
<title>Edge Security for Multi-Enterprise Data Exchanges using IBM | Miracle</title>
...
<?php include '../../header.php'; ?>
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="46"/>
