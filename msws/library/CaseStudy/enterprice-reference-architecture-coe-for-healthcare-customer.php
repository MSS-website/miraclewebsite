...
//            $conn->selectDatabase();
 ...
 $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=137";
...
//-------------------
 ...
 $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone) VALUES(3,137,'$rfirstname','$rlastName','$rorganization','$rdesignation','$remail','$rphone')";
...
//}
        ...
        ?>
<title>Enterprise Reference Architecture and CoE for Major Healthcare Customer | Miracle</title>
        ...
        <style>
            ...
            .section_bg{
                background: 
                    ...
                    /* your image */
                    url("<?= AMAZON_URL ?>/images/banners/NewIndustries/healthcare-2.png");
                -webkit-background-size: cover;
                -moz-background-size: cover;
                -o-background-size: cover;
                background-size: cover;
...
<input type="hidden" name="libId" id="libId" value="137"/>
            <br>
<!--            <br>
            <br>
            <br>
