...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=118";
        ...
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(3,118,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
<title>Legacy Modernization using Software AG webMethods for Global Manufacturer | Miracle</title>
 <?php include '../../config/Locations.php';?>
    ...
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="118"/>
            <br>
<!--            <br>
            <br>
            <br>
