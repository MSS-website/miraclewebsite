...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=113";
        ...
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(3,113,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
<title>Extended Monitoring and Visibility for Retailer with Miracle's EMF | Miracle</title>
...
<?php include '../../header.php'; ?>
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="113"/>
            <br>
<!--            <br>
            <br>
            <br>
