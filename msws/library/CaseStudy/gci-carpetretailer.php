...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=112";
        ...
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
               ...
               $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(3,112,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
<title>Global Commerce Integration Efforts for Major Carpet Retailer | Miracle</title>
    ...
    <body onload="getBodyContent(); getAuthors();">
       ...
       <section>
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="112"/>
            <br>
<!--            <br>
            <br>
            <br>
