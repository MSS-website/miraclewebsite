...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=136";
...
//-------------------
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone) VALUES(3,136,'$rfirstname','$rlastName','$rorganization','$rdesignation','$remail','$rphone')";
...
//}
        ...
        ?>
<title>EDGE Integration and Digital Platform for Major Pharmacy and Retailer | Miracle</title>
        ...
        <style>
            ...
            .section_bg{
                background: 
                    ...
                    /* your image */
                    url("<?= AMAZON_URL ?>/images/banners/NewIndustries/healthcare-3.png");
                -webkit-background-size: cover;
                -moz-background-size: cover;
                -o-background-size: cover;
                background-size: cover;
    ...
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="136"/>
            <br>
<!--            <br>
            <br>
            <br>
