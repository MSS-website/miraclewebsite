...
//            $conn->selectDatabase();
 ...
 $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=158";
...
//-------------------
 ...
 $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone) VALUES(3,158,'$rfirstname','$rlastName','$rorganization','$rdesignation','$remail','$rphone')";
...
//}
        ...
        ?>
<title>Smart SOA Implementation for Fortune 500 Healthcare Client | Miracle</title>
...
<input type="hidden" name="libId" id="libId" value="158"/>
