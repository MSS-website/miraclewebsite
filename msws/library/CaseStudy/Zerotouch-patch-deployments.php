...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=95";
        ...
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(3,95,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
<title>Zero-touch Patch Deployments for Major Construction Retailer | Miracle</title>
...
<?php include '../../header.php'; ?>
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="95"/>
            <br>
<!--            <br>
            <br>
            <br>
                            ...
                            <div class="tab-pane active " id="sign-in-for-access">
                                ...
                                <form method="post" action="<?php $_PHP_SELF ?>" id="myForm" >
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary col-md-12" data-loading-text="<i class='fa fa-spinner fa-spin '></i> loading..." style="margin-left:5px;" name="btnSubmit" id="btnSubmit" tabindex="12">Submit</button>	
