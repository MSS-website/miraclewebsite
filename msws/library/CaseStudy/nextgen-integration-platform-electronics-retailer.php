...
//            $conn->selectDatabase();
 ...
 $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=148";
...
//-------------------
 ...
 $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone) VALUES(3,148,'$rfirstname','$rlastName','$rorganization','$rdesignation','$remail','$rphone')";
...
//}
        ...
        ?>
<title>Establishing NextGen Integration Platform for Electronics Retailer | Miracle</title>
...
<input type="hidden" name="libId" id="libId" value="148"/>
            <br>
<!--            <br>
            <br>
            <br>
