...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=134";
...
//-------------------
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone) VALUES(3,134,'$rfirstname','$rlastName','$rorganization','$rdesignation','$remail','$rphone')";
...
//}
        ...
        ?>
<title>Hybrid Integration Architecture for Major Retail Customer | Miracle</title>
    ...
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="134"/>
            <br>
<!--            <br>
            <br>
            <br>
