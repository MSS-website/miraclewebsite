...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=128";
...
//-------------------
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone) VALUES(3,128,'$rfirstname','$rlastName','$rorganization','$rdesignation','$remail','$rphone')";
...
//}
        ...
        ?>
<title>Managed Network Operations Center for Global Manufacturer | Miracle</title>
        ...
        <style>
            ...
            .section_bg{
                background: 
                    ...
                    /* your image */
                    url("<?= AMAZON_URL ?>/images/banners/NewIndustries/manufacturing-3.png");
                -webkit-background-size: cover;
                -moz-background-size: cover;
                -o-background-size: cover;
                background-size: cover;
    ...
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="128"/>
            <br>
<!--            <br>
            <br>
            <br>
