...
<title>10 things that you need to know about IBM | Miracle</title>
 <?php include '../../config/Locations.php';?>
   ...
   <body onload="getBodyContent(); getAuthors();">
       ...
       <div id="loading" style="display: none"><img src="<?= AMAZON_URL ?>/images/loading.gif"/></div>
       
      <section class="container" id="about-us">
     
<input type="hidden" name="libId" id="libId" value="47"/>
            <br>
         <br>
         <br>
         <br>
