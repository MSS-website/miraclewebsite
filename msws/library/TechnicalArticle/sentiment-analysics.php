...
<!-- Title Will be same as page title-->
        <?php
								...
								try {
									...
									$selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=62";
								...
								if (isset ( $_POST ['btnSubmit'] )) {
									...
									try {
										...
										$sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " . " VALUES(3,62,:rfirstname,:rlastName,:rorganization," . ":rdesignation,:remail,:rphone)";
								...
								?>
<title>Understanding your user with Sentiment Analysis using Hadoop,
	Flume and MapReduce | Miracle</title>
...
<?php include '../../header.php'; ?>
				...
				<div class="row">
					<div class="col-sm-7 text-left">
						...
						<h1 class="micro" style="color: #ffffff;">
							<strong><span id="contentTitleId" /></span></strong>
						</h1>
	...
	<div id="loadingImage" style="display: none;" align="center">
		<img src="<?= AMAZON_URL ?>/images/loading.gif" />
	</div>

	<section class="container" id="about-us">
		<input type="hidden" name="isAuthorized" id="isAuthorized"
			value="<?= $checkFlag ?>" /> <input type="hidden" name="objectId"
			id="objectId" value="2" /> <input type="hidden" name="libId"
			id="libId" value="62" /> <br>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<p class="greyText heavy noMarginTop">
					<span id="publishedDateLabelId" /></span>
				</p>
				...
				<span id="pageContentId" /></span> <span id="pageContentId2" /></span>
...
<?php echo $rDocLongDesc; ?>
				...
				<div class="modal-footer">
					...
					<div class="row noMargin">
						...
						<div class="col-sm-6">
							<a href="../libray/index.php"><button type="button"
