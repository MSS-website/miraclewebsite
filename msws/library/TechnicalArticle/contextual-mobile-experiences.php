...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=92";
             ...
             //   $conn->connectToDatabase();
              ...
              //  $conn->selectDatabase();
               ...
               $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(3,92,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
<title>Contextual Mobile Experiences  with IBM Mobile First | Miracle</title>
        ...
        <style>
            ...
            .section_bg{
                background: 
                    ...
                    /* your image */
                    url("<?= AMAZON_URL ?>/images/banners/NewIndustries/energy-utilities-3.png");
                -webkit-background-size: cover;
                -moz-background-size: cover;
                -o-background-size: cover;
                background-size: cover;
    ...
    <body onload="getBodyContent(); getAuthors();">
       ...
       <section>
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="92"/>
            <br>
<!--            <br>
            <br>
            <br>
