...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=18";
        ...
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
              ...
              $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(2,18,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
        <title>
            WebMethods Integration Adapters | Miracle
        </title>
...
<?php include '../../header.php'; ?>
    <body>
				...
				<div class="row">
					<div class="col-sm-7 text-left">
						...
						<h1 class="micro" style="color: #ffffff;">
						  <strong> Integration made easy with webMethods Integration Adapters</strong> </h1>
					...
					<div class="col-sm-5 text-right">
                        ...
                        <li class="active">webMethods Product Brief
                        </li>
						</ul>
					</div>
				</div>
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="18"/>
            ...
            <br>
                <div class="col-sm-12">
                    ...
                    <h5 class="heavy noMargin">WebMethods Integration Platform
                    </h5>
                    <div class="row">
                        <div class="col-sm-3">
                            <hr>
                    ...
                    <h5 class="heavy noMargin">WebMethods Adapters</h5>
                    <div class="row">
                        <div class="col-sm-3">
                            <hr>
                        </div><!-- This is the divider line between the heading and the content -->
                    ...
                    <p class="methodText">
                        WebMethods comes bundled with multiple adapters, which ensures that we can quickly integrate with new systems and data. Software AG also provides a webMethods Adapter Framework, which provides a single location to manage all your locations.
                    </p>
                </div>     
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h6 class="heavy noMargin">
                        ...
                        <p class="methodText">
                            If you are an organization, which is migrating to the cloud with Salesforce.com, then the new challenge that comes to mind is how you can connect your on-premise applications to the cloud. This can be done quickly with the webMethods Salesforce Adapter in a no-code approach.
                        </p>
                        <p class="methodText">
                            This provides a seamless bi-directional connectivity between the cloud and your applications. The no-code approach ensures that you can communicate from the webMethods ESB to any salesforce.com by just mentioning the required fields and the service will be built for you. The adapter also comes with out-of-the-box features such as session management and meta-data introspection.
                        </p>
                        <center><img width="100%" src="<?= AMAZON_URL ?>/images/library/salesforce-adapter.png"></center>
                        <br>
                        <h6 class="heavy noMargin">
                            SAP Adapter
                            </h5>
                            ...
                            <center><img width="100%" src="<?= AMAZON_URL ?>/images/library/sap-adapter.png"></center>
                            <br><br>
                            <h6 class="heavy noMargin">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <center><img width="100%" src="<?= AMAZON_URL ?>/images/library/oracle-app-adapter.png"></center>
                                    </div>
                                </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <!-- <a href="../Documents/webMethods-Adapters.pdf"><button class="btn btn-primary btn-md" type="button">Download Product Brief</button></a> -->


                                        <!--       <a class="btn btn-primary btn-md" href="../resource/get-resource.php?refId=18&objectId=2">Download Product Brief</a> -->
                                        <a class="btn btn-primary btn-md" href='../../download/DownloadDocs.php?refId=18&objectId=2'>Download
