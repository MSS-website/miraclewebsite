...
//            $conn->selectDatabase();
 ...
 $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=169";
...
//-------------------
 ...
 $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone) VALUES(3,169,'$rfirstname','$rlastName','$rorganization','$rdesignation','$remail','$rphone')";
...
//}
        ...
        ?>
<title>The 7 Best Practices for building your own Enterprise Chat Bot | Miracle</title>
...
<input type="hidden" name="libId" id="libId" value="169"/>
