...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=65";
        ...
        if (isset($_POST['btnSubmit'])) {
            ...
            try {
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(3,65,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
<title>Simplifying the IoT Realization Process with IBM Bluemix and Raspberry Pi | Miracle</title>
    ...
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="65"/>
            <br>
            <!--            <br>
                        <br>
                        <br>
