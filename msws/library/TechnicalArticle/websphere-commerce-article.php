...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=88";
             ...
             //   $conn->connectToDatabase();
               ...
               // $conn->selectDatabase();
                ...
                $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(3,88,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
        <title>Bringing the power of the API Economy to IBM Websphere Commerce | Miracle</title>
         ...
         <style>
            ...
            .section_bg{
                background: 
                    ...
                    /* your image */
                    url("<?= AMAZON_URL ?>/images/banners/NewIndustries/energy-utilities-2.png");
                -webkit-background-size: cover;
                -moz-background-size: cover;
                -o-background-size: cover;
                background-size: cover;
    ...
    <body onload="getBodyContent(); getAuthors();">
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="88"/>
            <br>
<!--            <br>
            <br>
            <br>
                            ...
                            <div class="tab-pane active " id="sign-in-for-access">
                                ...
                                <div class="modal-footer noMargin" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"><button type="button" style="margin-left: -8px;" class="btn btn-primary col-sm-12" class="md-close" data-toggle="modal" data-target="#myModal1" data-dismiss="modal" style="margin-left:-9px;"><i class="fa fa-arrow-left" ></i> &nbsp; Back to Description</button></div>
