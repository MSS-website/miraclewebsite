...
//            $conn->selectDatabase();
 ...
 $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=281";
...
//-------------------
 ...
 $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone) VALUES(3,281,'$rfirstname','$rlastName','$rorganization','$rdesignation','$remail','$rphone')";
...
//}
        ...
        ?>
<title>The Evolution - User Interface (UI) to User Experience (UX) | Miracle</title>
        ...
        <style>
            ...
            .section_bg{
                background: 
                    ...
                    /* your image */
url('<?= AMAZON_URL ?>/images/banners/NewIndustries/Cross-Industry-1.png');
                -webkit-background-size: cover;
                -moz-background-size: cover;
                -o-background-size: cover;
                background-size: cover;
...
<input type="hidden" name="libId" id="libId" value="281"/>
