...
//            $conn->selectDatabase();
            ...
            $selectQuery = "SELECT DocTitle,DocType,DocLongDesc FROM tblWebDownloadsLines WHERE Id=63";
            ...
            try {
             ...
             //   $conn->connectToDatabase();
               ...
               $sql = "INSERT INTO tblResourceDepotDetails (ObjectId,RefId,FName,LName,Organization,Designation,Email,WorkPhone)   " .
                        " VALUES(3,63,:rfirstname,:rlastName,:rorganization," .
...
//}
        ...
        ?>
<title>Bring the power of your Cloud investments to Mobile with IBM MobileFirst and CastIron | Miracle</title>
...
.section_bg {
 ...
 <section>
				...
				<div class="row">
					<div class="col-sm-7 text-left">
						...
						<h1 class="micro" style="color: #ffffff;">
						   <strong> <span id="contentTitleId"/></span></strong></h1>
        ...
        <div id="loadingImage" style="display: none"><img src="<?= AMAZON_URL ?>/images/loading.gif"/></div>
        ...
        <section class="container" id="about-us">
            ...
            <input type="hidden" name="libId" id="libId" value="63"/>
            <br>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="row noMargin">
                            ...
                            <div class="col-sm-6"> <a href="../libray/index.php"><button type="button" class="btn btn-primary col-sm-12 "   >Go to Library</button></a></div>
                            <div class="col-sm-6">
